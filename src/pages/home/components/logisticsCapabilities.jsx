            ...
            <div className="content_wrap_one w-[100%] md:w-[60%]">
              <div>
                <Link
                  ...
                  className="no-underline text-gray-900 font-jost relative w-fit before:absolute before:-bottom-[20%] before:left-0 before:h-[1px] before:bg-gray-900 before:w-full duration-500 hover:before:w-0 before:duration-500 font-[500] text-[20px] flex items-center gap-3">
              ...
              <p
                data-aos="fade-up"
                data-aos-duration="2000"
                className="mt-5 w-fit font-jost text-[16px] lg:text-[17px] text-gray-700">
              ...
              <div
                ...
                {featuresData.map((features, index) => {
                  ...
                  return (
                    <div
                      className="md:grid grid-cols-2 font-jost block gap-[2rem] w-full"
                      key={index}>
                      <div>
                  ...
                  return (
                    <div
                      ...
                      <div className="text-gray-800 mt-[50px] w-full">
                        ...
                        <hr className="mt-3" />
                        <div className="mt-3">
                          <h3 className="text-gray-800 font-jost font-[500] text-[1.3rem]">
                            {title}
                          </h3>
                        </div>
                      </div>
