    ...
    <>
      <section className="hightlights py-[5rem] bg-white overflow-hidden">
        <div className='px-[20px] lg:px-[50px] w-full'>
          <Link to={'/news'} data-aos="fade-left" data-aos-duration="2000" className='no-underline ml-auto text-gray-900 relative w-fit before:absolute before:-bottom-[20%] before:left-0 before:h-[1px] before:bg-gray-900 before:w-full duration-500 hover:before:w-0 before:duration-500 font-[500] text-[20px] flex items-center gap-3'>
            ...
            <div className="mt-9">
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-[2rem]">
                {latesNewsData.map((data, index) => {
                  ...
                  return (
                    <Link key={index} to={'/'} data-aos="fade-up" data-aos-duration="2000" className='no-underline'>
