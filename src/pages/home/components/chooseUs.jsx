    ...
    <>
      <section className='py-[5rem] bg-white overflow-hidden'>
        <div className="px-[20px] lg:px-[50px] w-full">
          <Link to={'/about'} data-aos="fade-left" data-aos-duration="2000" className='no-underline ml-auto text-gray-900 relative w-fit before:absolute before:-bottom-[20%] before:left-0 before:h-[1px] before:bg-gray-900 before:w-full duration-500 hover:before:w-0 before:duration-500 font-[500] text-[20px] flex items-center gap-3'>
            <span>About Us</span>
          ...
          <div className="mt-8">
            <div className='block xl:flex gap-[5rem]'>
              <div className='content_wrap_one w-[100%] xl:w-[60%]'>
                ...
                <div className="mt-[50px]">
                  <div className="block md:flex gap-[2rem]">
                    <div className="tab_buttons" data-aos="fade-up" data-aos-duration="2000">
              ...
              <div data-aos="fade-left" data-aos-duration="2000" className="image_wrap mt-[100px] xl:mt-0 xl:w-[40%] xl:h-[100%] xl:mt-[100px] flex items-center justify-center">
